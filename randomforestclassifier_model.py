...
fit_get_score(clf, x_train, target_train, x_test, target_test) #70.71 % of the data was accurately predicted. 

   #fit the model with gini / get accuracy score. 
clf = RandomForestClassifier(n_estimators = 80, criterion = 'entropy', max_features = 4) 
fit_get_score(clf, x_train, target_train, x_test, target_test) #71.82 % of the data was accurately predicted. 
