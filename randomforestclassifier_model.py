...
#Normal Validataion Method. 
#Create a method for getting the model score. 
...
fit_get_score(clf, x_train, target_train, x_test, target_test) #69.06 % of the data was accurately predicted. 

   #fit the model with gini / get accuracy score. 
clf = RandomForestClassifier(n_estimators = 80, criterion = 'entropy') 
fit_get_score(clf, x_train, target_train, x_test, target_test) #72.92 % of the data was accurately predicted. 
...
fit_get_score(clf, x_train, target_train, x_test, target_test) #72.92 % of the data was accurately predicted. 
   ...
   #fit the model with gini / get accuracy score. 
clf = RandomForestClassifier(n_estimators = 80, criterion = 'entropy') 
fit_get_score(clf, x_train, target_train, x_test, target_test) #72.37 % of the data was accurately predicted. 
