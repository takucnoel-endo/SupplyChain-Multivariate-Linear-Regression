...
columns_to_drop = ['Sales', 'Category Id', 'Customer Email', 'Customer Fname', 'Customer Lname', \
                   ...
                   'Order Region', 'Order State', 'Order Status', 'Order Zipcode', 'Order Item Cardprod Id', \
                   'Product Card Id', 'Order Item Discount Rate', 'Order Item Total', 'Product Category Id', \
                   'Product Description', 'Product Image', 'Product Price', 'Product Status']

rename_dict = {'Type': 'Pmt_Type', 'Days for shipping (real)': 'LeadTime_Actual', \
               'Days for shipment (scheduled)': 'LeadTime_Schedule', 'Sales per customer': 'Sales', \
               'Category Name': 'Cat_Name', 'Customer City': 'Cust_City', 'Customer Country': 'Cust_Country', \
               'Customer Segment': 'Cust_Type', 'Market': 'Cust_Region', 'Department Name': 'Dep_Name', \
               'Order Customer Id': 'Cust_ID', 'order date (DateOrders)': 'Order_Date', 'shipping date (DateOrders)': 'Ship_Date', \
               'Order Id': 'Order_ID', 'Order Item Id': 'Order_ID', 'Order Item Product Price': 'Prod_Price', \
               'Order Item Profit Ratio': 'Profit_Ratio', 'Order Item Quantity': 'Order_Quantity', 'Order Profit Per Order': 'Order_Profit', \
               'Shipping Mode': 'Ship_Mode', 'Delivery Status': 'Delivery_Status', 'Late_delivery_risk': 'Late_Delivery_Risk'}
...
#I'll use my best of judgement to reassign these categories into more general groupings. 
